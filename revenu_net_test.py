...
crn.c(frais_proc_ass_emploi=500,pension_ex=15000)
...
crn.c(reer=1500, frais_demenagement=crn.fd(km_proximite_travail_etude=50, resiliation_bail=400, repas_par_jour=80, jour=16, entreposage=1000))
