...
crn.credit_dividende_determine()
crn.calcul_credits()
crn.credit_impot_etranger(montant_impot_etranger=150+45)
...
crn.calcul_credits()
crn.credit_contribution_parti_federaux(montant_contribution_parti_federaux=100)
crn.credit_impot_etranger(montant_impot_etranger=300)
print(crn.calcul_credits(montant_allocation_depart_retraite=3000)=="15970 10034 1656 1609")

print("*"*50, "423")
crb = rb.RevenuBrut()
crb.sb(salaire_net=98000/2, travailleur_autonome_rrq=5050, travailleur_autonome_rqap=[458, 258])
crb.rbe()
crb.dah(cot_professionnelle=800)
crb.calcul()
crn = rn.RevenuNet(crb=crb)
crn.rl(taxes_foncieres=5400, interets_sur_hypotheque=3000, entretien_et_reparation=2000, assurances=1000, fnacc=[25000,0.04], revenu_location=12000)
crn.a(revenu_dividende_determine=1800, revenu_interet=[3500+40,0], revenu_dividende_etranger=1275)
crn.b(gain_capital_imposable=4000)
crn.c()
crn.d()
print(crn.calcul()=="55724 + 2000 - 2725 - 0 = 54999")

print("*"*50, "424")
cauto = auto.Auto(portion_personnelle=10000, portion_totale=25000)
cauto.advantage_usage(mois=12, prix=41000)
cauto.advantage_fonction(choix=1, remb_employeur=5000)
cauto.calcul()
crb = rb.RevenuBrut(cauto=cauto)
crb.sb(salaire_net=65000-12000-14000-2991-664-342-2600, impot_fed=12000, impot_prov=14000, rrq=2991, ass_emploi=664, ass_parentale=342, rpa=2600)
crb.rbe(patron_cot_rpa=1800)
crb.dah()
crb.dahv()
crb.calcul()
crn = rn.RevenuNet(crb=crb)
crn.rl(entretien_et_reparation=3000, taxes_foncieres=4000, interets_sur_hypotheque=8000, assurances=1500, revenu_location=20000, fnacc=[90000,0.04])
crn.a(revenu_dividende_determine=9000, revenu_interet=[3000+10000*0.05+5000*0.05, 410], revenu_dividende_etranger=1700, revenu_entreprise=15000, revenu_entreprise_don = 1000)
crn.b(gain_capital_imposable=9000)
crn.c()
crn.d()
print(crn.calcul()=="103539 + 4500 - 0 - 0 = 108039")

print("*"*50, "426")
crb = rb.RevenuBrut()
crb.sb(salaire_net=350000, travailleur_autonome_rrq=5982, travailleur_autonome_rqap=[715, 402])
crb.rbe()
crb.travailleur_autonome(frais_entretien=3200, salaire_verse=40000, assurances_professionnelles=6000, frais_bancaires=225, congres=2250, loyer_paye=24000, fnacc_mobilier=[2500,0.2])
crb.calcul()
crb.credit_salaire()
crn = rn.RevenuNet(crb=crb)
crn.a(revenu_dividende_determine=600, revenu_interet=[1000,0])
crn.b(gain_capital_imposable=16000)
crn.c(reer=26500)
crn.d()
print(crn.calcul()=="275653 + 8000 - 29804 - 0 = 253849")
crn.credit_personnel_base()
crn.credit_transfere(montant_credit_transfere=1810)
crn.credit_scolarite(montant_scolarite=2000)
crn.credit_don(montant_don=500+200)
crn.credit_dividende_determine()
print(crn.calcul_credits(acompte_provisionnel=48000)=="63066 58338 9626 712")

print("*"*50, "429")
crb = rb.RevenuBrut()
crb.sb(salaire_net=90500, travailleur_autonome_rrq=2991*2, travailleur_autonome_rqap=[715,402])
crb.rbe()
crb.dah()
crb.calcul()
crb.credit_salaire()
crn = rn.RevenuNet(crb=crb)
crn.a(revenu_entreprise_don=3000, revenu_interet=[10500,0], revenu_dividende_determine=600)
crn.b()
crn.c()
crn.d()
crn.calcul()
...
crn.credit_don()
crn.credit_dividende_determine()
crn.credit_contribution_parti_federaux(montant_contribution_parti_federaux=467)
crn.credit_investissement(montant_investissement=[550000,0.1])
crn.calcul_credits()
